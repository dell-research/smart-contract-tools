...
class ContractDefinitionTest {
    ...
    val VALID_CONTRACT_DEFINITION = '''
        contract «CONTRACT_NAME_1» {}
    '''

    @Test
    def void givenValidContractDefinition_thenNoErrors() {
        VALID_CONTRACT_DEFINITION.parse.assertNoErrors
    }

    @Test
    def void givenValidContractDefinition_withName_thenParsedNameIsCorrect() {
        Assert::assertEquals(CONTRACT_NAME_1,  VALID_CONTRACT_DEFINITION.parse.contract.last.name);
    }
