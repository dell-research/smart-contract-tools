...
class FunctionCallListArgumentsTest {
    @Inject extension ParseHelper<Solidity>;
    @Inject extension ValidationTestHelper

    val VALID_FUNCTION_CALL_LIST_ARGUMENTS = '''
        {}
    '''
    ...
    def void givenValidExpression_thenNoErrors() {
        VALID_FUNCTION_CALL_LIST_ARGUMENTS.parse.assertNoErrors
    }

} // FunctionCallListArgumentsTest
