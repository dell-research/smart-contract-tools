...
class PlaceholderStatementTest {
    @Inject extension ParseHelper<Solidity>;
    @Inject extension ValidationTestHelper

    val VALID_PLACEHOLDER_STATEMENT = '''
        {}
    '''

    @Ignore
    @Test
    def void givenValidPlaceholderStatement_thenNoErrors() {
        VALID_PLACEHOLDER_STATEMENT.parse.assertNoErrors
    }

} // PlaceholderStatementTest
