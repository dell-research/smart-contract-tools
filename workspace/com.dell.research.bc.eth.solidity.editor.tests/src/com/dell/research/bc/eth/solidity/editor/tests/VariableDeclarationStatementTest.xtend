...
class VariableDeclarationStatementTest {
    ...
    val VALID_VARIABLE_DECLARATION_STATEMENT = '''
        {}
    '''

    @Ignore
    @Test
    def void givenValidVariableDeclarationStatement_thenNoErrors() {
        VALID_VARIABLE_DECLARATION_STATEMENT.parse.assertNoErrors
    }
