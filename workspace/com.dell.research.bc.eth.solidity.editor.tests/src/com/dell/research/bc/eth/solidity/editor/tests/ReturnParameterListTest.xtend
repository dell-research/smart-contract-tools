...
class ReturnParameterListTest {
    @Inject extension ParseHelper<Solidity>;
    @Inject extension ValidationTestHelper

    val VALID_RETURN_PARAMETER_LIST = '''
        {}
    '''

    @Ignore
    @Test
    def void givenValidReturnParameterList_thenNoErrors() {
        VALID_RETURN_PARAMETER_LIST.parse.assertNoErrors
    }

} // ReturnParameterListTest
