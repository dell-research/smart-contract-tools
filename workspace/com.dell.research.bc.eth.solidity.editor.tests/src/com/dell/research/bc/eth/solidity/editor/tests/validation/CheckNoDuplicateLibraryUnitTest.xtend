...
class CheckNoDuplicateLibraryUnitTest extends AbsSolidityValidatorUnitTest {
    @Inject extension ParseHelper<Solidity>;
    @Inject extension ValidationTestHelper;

    @Test
    def void givenTwoLibraries_whenDifferentNames_thenNoError() {
        '''
            library A {}
            library B {}
    ...
    @Test
    def void givenTwoLibraries_whenHaveSameName_thenError() {
        '''
            library A {}
            library A {}
...
} // CheckNoDuplicateLibraryUnitTest