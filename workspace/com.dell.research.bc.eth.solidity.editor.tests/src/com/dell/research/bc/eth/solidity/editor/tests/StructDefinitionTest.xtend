...
class StructDefinitionTest extends AbsSolidityUnitTest {
    @Inject extension ParseHelper<Solidity>;
    @Inject extension ValidationTestHelper

    val VALID_STRUCT_DEFINITION = '''
        {}
    '''

    @Ignore
    @Test
    def void givenValidStructDefinition_thenNoErrors() {
        VALID_STRUCT_DEFINITION.parse.assertNoErrors
    }

} // StructDefinitionTest
