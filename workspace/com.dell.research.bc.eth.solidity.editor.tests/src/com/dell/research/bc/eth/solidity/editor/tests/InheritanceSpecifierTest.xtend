...
class InheritanceSpecifierTest {
    ...
    val VALID_INHERITANCE_SPECIFIER = '''
        {}
    '''

    @Ignore
    @Test
    def void givenValidInheritanceSpecifier_thenNoErrors() {
        VALID_INHERITANCE_SPECIFIER.parse.assertNoErrors
    }

} // InheritanceSpecifierTest
